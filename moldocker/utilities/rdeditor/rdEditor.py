...
from PySide6.QtGui import QDesktopServices, QIcon, QAction, QKeySequence, QGuiApplication
...
class MainWindow(QtWidgets.QMainWindow):
    doneDrawingSignal = Signal()
    
    def __init__(self, fileName=None, loglevel="WARNING", darkmode_stat=True):
        ...
        self.editor = MolEditWidget(darkmode_stat=darkmode_stat)
        self.editor.finishedDrawing.connect(self.signal_done_drawing)
        self.is_dark_mode = darkmode_stat
    ...
    def signal_done_drawing(self):
        self.doneDrawingSignal.emit()
    ...
    def initGUI(self, fileName=None):
        ...
        self.center.setFixedSize(int(screen_size.width() * 0.8), int(screen_size.height() * 0.7))
