...
class MolWidget(QtSvgWidgets.QSvgWidget):
    def __init__(self, mol=None, parent=None, darkmode_stat=True):
    ...
    def getMolSvg(self):
        ...
        self.drawer = rdMolDraw2D.MolDraw2DSVG(int(screen_size.width() * 0.8), int(screen_size.height() * 0.7))
