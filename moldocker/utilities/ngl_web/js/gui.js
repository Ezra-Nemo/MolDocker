...
NGL.StageWidget = function (stage, theme_default='dark') {
  ...
  preferences.storage['theme'] = theme_default
  ...
  // Set the inital sidebar width to 0 to hide it at default
  var initialSidebarWidth = 5;
  sidebar.setWidth(initialSidebarWidth + 'px');
  var mainWidth = window.innerWidth - initialSidebarWidth;
